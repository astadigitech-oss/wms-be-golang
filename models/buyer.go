...
type Buyer struct {
	...
	LoyaltyRankID    		uint64     `gorm:"column:loyalty_rank_id;not null;index" json:"loyalty_rank_id"`
	...
	TransactionCount 	int        `gorm:"column:transaction_count;type:int;default:0" json:"transaction_count"`
