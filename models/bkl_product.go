...
type BklProduct struct {
	ID            		uint64      `gorm:"primaryKey;autoIncrement" json:"id"`
	CodeDocument  		string     `gorm:"size:50;not null" json:"code_document"`
	...
	// Relations
	Document	*BklDocument `gorm:"foreignKey:CodeDocument;references:CodeBkl" json:"document,omitempty"`
...
func (p *BklProduct) GetDaysSinceCreated() string {
