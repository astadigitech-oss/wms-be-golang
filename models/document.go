...
type Document struct {
	...
	Code      			string         `gorm:"size:255;uniqueIndex;not null" json:"code_document"`
	...
	StatusDocument    	string        `gorm:"type:enum('pending','inprogress','done');default:'pending';size:50;not null" json:"status_document"`
	CustomBarcode     	*string        `gorm:"size:255" json:"custom_barcode"`
