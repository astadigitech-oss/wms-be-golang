...
type ApproveQueue struct {
    ...
    ProductID 		  *uint `gorm:"unique" json:"product_id"`
    Type              *string `gorm:"column:type" json:"type"`
    CodeDocument      *string `gorm:"column:code_document" json:"code_document"`
    OldPriceProduct   *float64 `gorm:"type:decimal(15,2)" json:"old_price_product"`
	NewNameProduct    *string `json:"new_name_product"`
	...
	ColorTagID       *uint64 `json:"color_tag_id"`
	CategoryID        *uint64 `json:"category_id"`
	Status		  string `gorm:"type:enum('0','1');size:50;not null" json:"status"`
